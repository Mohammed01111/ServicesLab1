...
namespace ServicesLab1
{
    internal class Program
    {
        static void Main(string[] args)
        {
            ...
            var bankService = new BankService(BankAccountRepository, transactionService);
            ...
            var newAccount = new BankAccount
            {
                ...
                Balance = 5000,
                UserId = 1 // Assume this user exists
            };
            BankAccountRepository.AddAccount(newAccount);

            // Deposit
            bankService.Deposit(newAccount.Id, 1000);

            // Withdraw
            bankService.Withdraw(newAccount.Id, 500);

            // Transfer
            var destinationAccountId = 2; // Assume this account exists
            bankService.Transfer(newAccount.Id, destinationAccountId, 200);
